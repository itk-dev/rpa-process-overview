(function(factory) {
  ...
  function autoEmbedWithTarget(component, targetId) {
  ...
  var root_2 = /* @__PURE__ */ from_html(`<h1>No results matching <em class="query"> </em></h1>`);
  var root_4 = /* @__PURE__ */ from_html(`<h1>One result matching <em class="query"> </em></h1>`);
  var root_5 = /* @__PURE__ */ from_html(`<h1> <em class="query"> </em></h1>`);
  var root_1 = /* @__PURE__ */ from_html(`<!> <code><pre> </pre></code>`, 1);
  var root_6 = /* @__PURE__ */ from_html(`<p>Enter a non-empty query.</p>`);
  var root = /* @__PURE__ */ from_html(`<form><div class="mb-3"><input type="search" class="form-control" placeholder="Search" aria-label="Search"/></div></form> <!> <details><summary>Config and data</summary> <code><pre> </pre></code></details>`, 1);
  function ProcessSearch($$anchor, $$props) {
    ...
    user_effect(() => {
      ...
      if (get(parsedQuery)) {
        ...
        set(data, null);
        fetch(url.toString()).then((response) => response.json()).then((result) => set(data, result, true));
      }
    });
    var fragment = root();
    ...
    var node = sibling(form, 2);
    {
      var consequent_2 = ($$anchor2) => {
        ...
        var node_1 = first_child(fragment_1);
        {
          var consequent = ($$anchor3) => {
            var h1 = root_2();
            var em = sibling(child(h1));
            var text = child(em);
            template_effect(() => set_text(text, get(parsedQuery)));
            append($$anchor3, h1);
          };
          var alternate_1 = ($$anchor3) => {
            ...
            var node_2 = first_child(fragment_2);
            {
              var consequent_1 = ($$anchor4) => {
                var h1_1 = root_4();
                var em_1 = sibling(child(h1_1));
                var text_1 = child(em_1);
                template_effect(() => set_text(text_1, get(parsedQuery)));
                append($$anchor4, h1_1);
              };
              var alternate = ($$anchor4) => {
                var h1_2 = root_5();
                var text_2 = child(h1_2);
                var em_2 = sibling(text_2);
                var text_3 = child(em_2);
                template_effect(() => {
                  set_text(text_2, `${get(data)?.rows?.length ?? ""} results matching `);
                  set_text(text_3, get(parsedQuery));
                });
                append($$anchor4, h1_2);
              };
              if_block(
                node_2,
                ($$render) => {
                  if (1 === get(data)?.rows?.length) $$render(consequent_1);
          ...
          if_block(node_1, ($$render) => {
            if (0 === (get(data)?.rows ?? []).length) $$render(consequent);
            else $$render(alternate_1, false);
          });
        }
        var code = sibling(node_1, 2);
        var pre = child(code);
        var text_4 = child(pre);
        template_effect(($0) => set_text(text_4, $0), [() => JSON.stringify(get(data)?.rows)]);
      ...
      if_block(node, ($$render) => {
        if (get(parsedQuery)) $$render(consequent_2);
        else $$render(alternate_2, false);
      });
    }
    var details = sibling(node, 2);
    var code_1 = sibling(child(details), 2);
    var pre_1 = child(code_1);
    var text_5 = child(pre_1);
    template_effect(($0) => set_text(text_5, $0), [() => JSON.stringify({ config, data: get(data) }, null, 2)]);
